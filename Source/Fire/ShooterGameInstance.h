...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(FKillInfoUPdateDelegate,
                                              FString, killerName, FString, KilledName, int, KillerSide, int,
                                              KilledSide, UTexture2D*, Icon);
